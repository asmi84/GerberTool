...
{
    [DebuggerDisplay("Operation Move, X={X}, Y={Y}")]
    public class OperationMoveCommand : GerberFunctionCodeCommand, IContainsUnits
    {
        public const string COMMAND_CODE = "D02";
        ...
        public static GerberFunctionCodeCommand Create(string data)
        {
            ...
            var cmd = new OperationMoveCommand();
